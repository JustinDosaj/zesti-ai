...
import { Cog6ToothIcon, HomeIcon, DocumentPlusIcon, UserIcon, Bars3Icon, XMarkIcon } from '@heroicons/react/24/outline'
                        ...
                        <ul role="list" className="flex flex-1 flex-col gap-y-7">
                            ...
                            <ul role="list" className="-mx-2 space-y-1">
                                ...
                                <li key={item.name}>
                                    ...
                                    <item.icon
                                        className={classNames(
                                        currentPath === item.href ? 'text-primary-main' : 'text-gray-400 group-hover:text-primary-main',
                                        'h-6 w-6 shrink-0'
                                        )}
                                        aria-hidden="true"
                                    />
