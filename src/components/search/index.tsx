...
interface SearchProps {
    searchType: "home" | "my-recipes" | "creator" | "creator-settings"
}


export function NewSerach({searchType}: SearchProps){
    return(
        <>
        </>
    )
...
export function Search() {
    ...
    const renderSearchResults = () => {
        ...
        return (
            <div className="absolute z-20 mt-16 w-full max-w-xs lg:max-w-lg bg-white shadow-lg border border-gray-200 rounded-3xl">
                ...
                <div className="w-full flex flex-col items-center">
                    <div className="flex sm:flex-row flex-col gap-5">
                        <form action="" method="POST" className="py-1 pl-6 pr-6 flex gap-3 items-center text-heading-3 shadow-lg shadow-box-shadow border border-box-border bg-box-bg rounded-full ease-linear focus-within:bg-body  focus-within:border-primary">
                            ...
                            <input type="text" autoComplete="off" name="web-page" value={input} placeholder="Search TikTok Username or Recipe" className="text-left w-56 lg:w-96 text-gray-500 py-3 outline-none bg-transparent" onChange={(e) => setInput(e.target.value)}/>
