...
export function GridDisplay({data}: any) {
    ...
    return(
        ...
        const nameParse = JSON.parse(recipe.data.message.content)
        const name = JSON.parse(nameParse)
        console.log(name)
            ...
            <div className="flex w-full items-center justify-between space-x-6 p-6">
              <div className="flex-1 truncate">
                <div className="flex items-center space-x-3">
                  <h3 className="truncate text-sm font-medium text-gray-900">{name.name}</h3>
