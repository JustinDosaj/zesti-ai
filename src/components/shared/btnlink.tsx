...
export function BtnLink({href, text, className}:Props) {
    return(
        <Link href={href} className={`text-white bg-primary-main px-6 py-3 rounded-full outline-none relative overflow-hidden border duration-300 ease-linear after
