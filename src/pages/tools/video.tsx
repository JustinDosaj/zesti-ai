  ...
  return (
    <>
      ...
      <main className={`flex min-h-screen flex-col items-center bg-background ${raleway.className}`}>
        <ToolHero role={stripeRole} tokens={tokens} titleStart="Save Recipes From" titleEnd='TikTok & YouTube' description="Copy a video link from Tiktok then paste it below to transcribe the recipe to text!"/>
        { isLoading == true ?
        <ToolLoader/>
        :
