...
export default function Essential() {
  ...
  return (
    <>
    <Head>
        <title>Zesti Essential | Chatgpt Cooking Assistant | Most Popular</title>
        <meta name="title" content="Zesti Essential | Most Popular Chatgpt Cooking Assistant"/>
    ...
    <main className={`flex min-h-screen flex-col items-center justify-between bg-background ${raleway.className}`}>
        ...
        <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
            <h1 className="text-4xl/tight sm:text-4xl/tight md:text-5xl/tight xl:text-6xl/tight font-bold text-heading-1 mt-6">     
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-br from-primary-main from-20% via-primary via-30% to-color-alt-red"> Essential</span>
            </h1>
