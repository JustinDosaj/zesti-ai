...
import { RecipeDataComponent, RecipeIngredientsComponent, RecipeInstructionsComponent, RecipeTitleCard } from '@/components/ui/recipe';
import { TestContainer } from '@/components/shared/container';
...
const Recipe: React.FC = ({ recipe, ogUrl }: any) => {
    ...
    return (
      <>
        ...
        <main className="bg-background min-h-screen flex justify-center py-10 px-4 sm:px-8 md:px-14 lg:px-5">
