    ...
    <>
      ...
      <div className="max-w-5xl mx-auto flex justify-center space-x-10">
        <div className={`w-full lg:w-5/6 lg:max-w-[728px] space-y-10 lg:mt-10 mt-8`}>
            ...
            <AdSense className="mx-auto" adSlot="3721531543" adFormat="auto" adStyle={{ width: '100%', height: '90px' }} role={stripeRole}/>
            {source == "tiktok" ? <TikTokVideo video_id={video_id}/> : <InstagramComponent video_id={video_id}/>} 
            <AdSense className="mx-auto"  adSlot="6960485708" adFormat="auto" adStyle={{ width: '100%', height: '90px' }} role={stripeRole}/>
            <RecipeIngredientsComponent ingredients={ingredients} /> 
            <AdSense className="mx-auto"  adSlot="2408449875" adFormat="auto" adStyle={{ width: '100%', height: '90px' }} role={stripeRole}/>
