    ...
    return (
        <>
            ...
            <main className={`flex min-h-screen flex-col items-center bg-background w-full space-y-4 pb-48`}>
                ...
                <AdSense className="mx-auto max-w-[320px] md:max-w-[728px]" adSlot="5445664417" adFormat="horizontal" adStyle={{ width: '100%', maxHeight: '90px', height: '90px' }} role={stripeRole}/> 
