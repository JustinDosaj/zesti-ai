...
// Function to initiate TikTok login
  const loginWithTikTok = async () => {
    ...
    const tikTokUrl = `https://www.tiktok.com/v2/auth/authorize/?client_key=${process.env.NEXT_PUBLIC_TIKTOK_CLIENT_KEY}&scope=user.info.basic,user.info.profile,video.list&response_type=code&redirect_uri=${encodeURIComponent(`https://${process.env.NEXT_PUBLIC_DOMAIN_NAME}/auth/redirect`)}&state=true`;
