...
exports.test_detectNewURLRecipe = onDocumentCreated("users/{userId}/recipes/{documentId}", async (event) => {
...
exports.test_detectNewPayment = onDocumentCreated("users/{userId}/payments/{documentId}", async (event) => {
    //Get Params
    const userId = event.params.userId;
    const documentId = event.params.documentId;
